...
@UNKNOWN0:
	...
	LDA @LOCAL0B
	JSR GET_OVERWORLD_SPRITE_TILE_SIZE
	STA @VIRTUAL02
	LDY @VIRTUAL04
	LDX NEW_SPRITE_TILE_HEIGHT
	LDA NEW_SPRITE_TILE_WIDTH
	JSL RESERVE_OVERWORLD_SPRITE_VRAM
	STA @LOCAL07
@UNKNOWN1:
	LDA @LOCAL07
	CMP #$7FFF
	BGT @UNKNOWN1
	LOADPTR OVERWORLD_SPRITE_TEMPLATE_POINTERS, @VIRTUAL06
	LDA @VIRTUAL02
	OPTIMIZED_MULT @VIRTUAL04, 4
	CLC
	ADC @VIRTUAL06
...
@UNKNOWN6:
	...
	ASL
	TAX
	LDA f:OVERWORLD_SPRITE_VRAM_OFFSETS,X
	CLC
	ADC #$4000
	LDX @LOCAL04
	STA __BSS_START__,X

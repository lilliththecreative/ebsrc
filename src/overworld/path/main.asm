...
@UNKNOWN0:
	...
	LDX @LOCAL0E
	LDA @LOCAL0D
	JSR INITIALIZE_PATHERS
	LDA @LOCAL10
	ASL
	ASL
	JSR PATH_SBRK
	STA @LOCAL0E
	JSR INITIALIZE_PATH_MATRIX
	STZ @LOCAL06
	STZ @LOCAL05
	LDA #0
	STA @VIRTUAL04
...
@UNKNOWN6:
	...
	CLC
	ADC #6
	JSR BUILD_PATH_POINTS
	LDX @VIRTUAL02
	STA __BSS_START__+14,X
	LDX @LOCAL0E
	JSR PATH_TRIM_REDUNDANCIES
	STA @LOCAL03
	ASL
	ASL
	JSR PATH_SBRK

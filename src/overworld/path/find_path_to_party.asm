...
.ENDIF
	...
	TAY
	STY @LOCAL08ALT
	LOADPTR COLLISION_WIDTHS, @VIRTUAL0A
	LDA @LOCAL0BALT
	CLC
	...
	TAX
	LOADPTR COLLISION_HEIGHTS, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL06
	LDA (@LOCAL07)
	ASL
	STA @LOCAL05
	LOADPTR COLLISION_HEIGHTS2, @LOCAL04
	LDA @LOCAL05
	TAY
	CLC
	ADC @VIRTUAL06
	...
	LDX @LOCAL0C
	LDA @LOCAL0A
	JSR PERFORM_ENTITY_PATHFINDING
	END_C_FUNCTION

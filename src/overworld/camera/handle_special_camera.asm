...
@UNKNOWN4:
	...
	ADD_INT_ASSIGN @VIRTUAL06, @VIRTUAL0A
	MOVE_INT_YPTRDEST @VIRTUAL06, __BSS_START__
	LDX #.LOWORD(GAME_STATE) + game_state::auto_scroll_frames
	LDA __BSS_START__,X
	DEC
	STA __BSS_START__,X
	BNE @UNKNOWN5
	...
	LDX @VIRTUAL02
	STA __BSS_START__,X
	LDA GAME_STATE + game_state::auto_scroll_original_walking_style

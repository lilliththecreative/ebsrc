...
@UNKNOWN9:
	...
	TAX
	LDA __BSS_START__,X
	ORA #ENTITY_OVERLAY_FLAGS::MUSHROOM | ENTITY_OVERLAY_FLAGS::UNKNOWN13 | ENTITY_OVERLAY_FLAGS::UNKNOWN12
	STA __BSS_START__,X
...
@UNKNOWN11:
	...
	BNE @UNKNOWN13
	LDA @LOCAL02
	JSR PICK_NEXT_BUBBLE_MONKEY_MOVEMENT_MODE
	LDA BUBBLE_MONKEY_MODE
	CMP #3
	BNE @UNKNOWN12
	LDA #4

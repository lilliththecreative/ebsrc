...
@UNKNOWN8:
	...
	BRA UPDATE_ENTITY_SPRITE_CURRENT_COMMON
UPDATE_ENTITY_SPRITE_CURRENT_FRAME_COUNTER:
	LDA FRAME_COUNTER
	LSR
	LSR
	LSR
...
UPDATE_ENTITY_SPRITE_CURRENT:
	...
	TCD
	PLA
	BRA UPDATE_ENTITY_SPRITE_BY_FRAME_VAR_COMMON
UPDATE_ENTITY_SPRITE_2:
	REP #PROC_FLAGS::ACCUM8
	PHD
	PHA
	TDC
	...
	ASL
	TAY
UPDATE_ENTITY_SPRITE_BY_FRAME_VAR_COMMON:
	LDA ENTITY_ANIMATION_FRAME,Y
	STA USE_SECOND_SPRITE_FRAME
	JSL UPDATE_ENTITY_SPRITE_OFFSET
	PLD
	RTL
UPDATE_ENTITY_SPRITE_CURRENT_FRAME0:
	STZ USE_SECOND_SPRITE_FRAME
	JSL IS_ENTITY_SPRITE_ONSCREEN
	BNE UPDATE_ENTITY_SPRITE_CURRENT_COMMON
	RTL
UPDATE_ENTITY_SPRITE_CURRENT_FRAME1:
	LDA #$0001
	STA USE_SECOND_SPRITE_FRAME
	JSL IS_ENTITY_SPRITE_ONSCREEN
	BNE UPDATE_ENTITY_SPRITE_CURRENT_COMMON
	RTL
UPDATE_ENTITY_SPRITE_CURRENT_FRAME0_FORCED:
	STZ USE_SECOND_SPRITE_FRAME
UPDATE_ENTITY_SPRITE_CURRENT_COMMON:
	LDY $88
UPDATE_ENTITY_SPRITE_OFFSET:
	STY $08
...
@UNKNOWN13:
	...
	LDA #$0003
	STA DMA_COPY_MODE
	LDA #.BANKBYTE(BLANK_TILES)
	STA DMA_COPY_RAM_SRC + 2
	REP #PROC_FLAGS::ACCUM8
	LDA #.LOWORD(BLANK_TILES)
	STA DMA_COPY_RAM_SRC
	JSL UPDATE_SPRITE_TILE_ROW
	DEC $00
	BEQ @UNKNOWN16
	LDA $06
	AND #$0004

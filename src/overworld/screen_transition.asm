...
@NOT_MAX_DURATION:
	...
	LDA [@VIRTUAL06],Y
	JSL BACKGROUND_SLIDE_INITIALIZATION
	LDY @LOCAL06
	CPY #1
	BNEL @UNKNOWN10
	JSL FREEZE_ENTITIES
...
@UNKNOWN4:
	...
	JSL OAM_CLEAR
	JSL BACKGROUND_SLIDE_FRAME_ADVANCE
	JSL BACKGROUND_SLIDE_SPRITE_FRAME_ADVANCE
	JSL RUN_ACTIONSCRIPT_FRAME
	JSL UPDATE_SCREEN
	JSL UPDATE_SWIRL_FRAME
	JSL WAIT_UNTIL_NEXT_FRAME
	LDA @LOCAL02
	INC
	STA @LOCAL02

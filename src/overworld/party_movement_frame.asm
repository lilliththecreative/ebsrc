...
DO_PARTY_MOVEMENT_FRAME:
	...
	LDX @VIRTUAL02
	LDA @LOCAL02
	JSL DETERMINE_PARTY_MEMBER_SPRITE
	STA @LOCAL01
	CMP #.LOWORD(-1)
	BNE @UNKNOWN0
	LDA @VIRTUAL04
...
@UNKNOWN0:
	...
	TAX
	LDA __BSS_START__,X
	ORA #ENTITY_OVERLAY_FLAGS::SWEATING
	STA __BSS_START__,X
@UNKNOWN1:
	...
	TAX
	LDA __BSS_START__,X
	AND #$FFFF ^ (ENTITY_OVERLAY_FLAGS::SWEATING | ENTITY_OVERLAY_FLAGS::MUSHROOM | ENTITY_OVERLAY_FLAGS::UNKNOWN13)
	STA __BSS_START__,X
	BRA @UNKNOWN3
@UNKNOWN2:
	LDA @VIRTUAL04
	...
	TAX
	LDA __BSS_START__,X
	ORA #ENTITY_OVERLAY_FLAGS::MUSHROOM | ENTITY_OVERLAY_FLAGS::UNKNOWN13
	STA __BSS_START__,X
@UNKNOWN3:
	...
	TAX
	LDA __BSS_START__,X
	ORA #ENTITY_OVERLAY_FLAGS::UNKNOWN12
	STA __BSS_START__,X
@UNKNOWN4:
	END_C_FUNCTION

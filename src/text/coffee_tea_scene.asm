...
COFFEETEA_SCENE:
	...
	JSL PREPARE_NEW_FLYOVER_COFFEETEA_SCENE
	JSL OAM_CLEAR
	LDA @VIRTUAL02
...
@PARSE_09:
	LDA @VIRTUAL04
	JSL COFFEETEA_SINGLE_FRAME_SCROLL
	TAX
	STX @LOCAL00
	LDA #24
	JSL FLYOVER_COPY_RENDERED_TEXT
...
@PARSE_08:
	...
	LDX #12
	TYA
	JSL RENDER_FLYOVER_PARTY_MEMBER_NAME
	BRA @SCRIPT_PARSE_BEGIN
@PRINT_TEXT:
	LDY #12
	LDX #0
	JSL RENDER_FLYOVER_CHARACTERS

...
@UNKNOWN0:
	...
	LDA @LOCAL06
	DEC
	JSR PRINT_MENU_ITEMS_PRESELECTED
	LDA #1
	JSR SELECTION_MENU
	STA @LOCAL06
...
@UNKNOWN10:
	...
	LDX #0
	LDA #1
	JSR PRINT_MENU_OPTION_TABLE_PRESELECTED
	LDA @LOCAL07
	SEP #PROC_FLAGS::ACCUM8
	INC
	...
	BRA @UNKNOWN16
@UNKNOWN12:
	LOADPTR PRINT_STATS_WITH_NEW_WEAPON, @LOCAL00
	JSR SET_MENU_CALLBACK
	BRA @UNKNOWN16
@UNKNOWN13:
	LOADPTR PRINT_STATS_WITH_NEW_BODY_GEAR, @LOCAL00
	JSR SET_MENU_CALLBACK
	BRA @UNKNOWN16
@UNKNOWN14:
	LOADPTR PRINT_STATS_WITH_NEW_ARMS_GEAR, @LOCAL00
	JSR SET_MENU_CALLBACK
	BRA @UNKNOWN16
@UNKNOWN15:
	LOADPTR PRINT_STATS_WITH_NEW_OTHER_GEAR, @LOCAL00
	JSR SET_MENU_CALLBACK
@UNKNOWN16:
	LDA #1

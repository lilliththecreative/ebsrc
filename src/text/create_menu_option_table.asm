...
@UNKNOWN1:
	...
	LDA #30
	JSL GET_STRING_RENDERING_WIDTH
	SEP #PROC_FLAGS::ACCUM8
	CLC
	ADC #8
	LDX @VIRTUAL04
...
@UNKNOWN6:
	...
	LDY #window_stats::current_option
	LDA (@LOCAL0A),Y
	JSL REDIRECT_GET_MENU_OPTION_COUNT
	LDX @LOCAL06
	STX @VIRTUAL02
	LDY @LOCAL0B
	CLC
...
@UNKNOWN23:
	LDY @LOCAL07
	BNE @UNKNOWN22
	LOADPTR MENU_NEXT_LABEL, @LOCAL00
	...
	LDX #0
	TXA
	JSL CREATE_NEW_MENU_OPTION_AT_POSITION_WITH_USER_DATA_FAR

...
@UNKNOWN76:
	...
	JMP @UNKNOWN151
@UNKNOWN77:
	JSL GET_DEFAULT_MUSIC
	LDX #0
	JSL SET_OVERWORLD_MUSIC_OVERRIDE
	JMP @UNKNOWN150
@UNKNOWN78:
	LDA #.LOWORD(CC_1F_04)
	JMP @UNKNOWN151
...
@UNKNOWN109:
	...
	JMP @UNKNOWN151
@UNKNOWN110:
	JSL BACKUP_CLEAR_PARTY_NPCS_MONEY
	JMP @UNKNOWN150
@UNKNOWN111:
	JSL RESTORE_PARTY_BACKUP
	JMP @UNKNOWN150
@UNKNOWN112:
	LDA #.LOWORD(CC_1F_66)
	JMP @UNKNOWN151

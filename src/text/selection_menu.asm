...
@UNKNOWN13:
	...
	ASL
	STA @LOCAL04
	LOADPTR SELECTION_CURSOR_FRAMES_UPPER, @VIRTUAL06
	LDA @LOCAL04
	CLC
	ADC @VIRTUAL06
	STA @VIRTUAL06
	...
	.A16
	LOADPTR SELECTION_CURSOR_FRAMES_LOWER, @VIRTUAL06
	LDA @LOCAL04
	CLC
	ADC @VIRTUAL06
	STA @VIRTUAL06
...
.IF .DEFINED(PROTOTYPE19950327)
	JSL REMOVE_WINDOW_FROM_SCREEN_OLD
.ELSE

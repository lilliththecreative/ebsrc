...
.ENDIF
	...
	JSL CHANGE_MUSIC
	JSL RESET_OVAL_WINDOW
	LDX #0
	STX @LOCAL04
	BRA @UNKNOWN1
@UNKNOWN0:
	LDA #$03E0
	JSR FULLSCREEN_COLOUR_FLAGS
	LDA #$001F
	JSR FULLSCREEN_COLOUR_FLAGS
	LDA #$7C00
	JSR FULLSCREEN_COLOUR_FLAGS
...
@UNKNOWN5:
	...
	LDY @LOCAL02ALT
	MOVE_INT_YPTRSRC 0, @VIRTUAL06 ;@VIRTUAL06 = game_state.money_earned_since_last_call
	CLC
	ADD_INT_ASSIGN @VIRTUAL06, @VIRTUAL0A ;@VIRTUAL06 += @VIRTUAL0A
	MOVE_INT_YPTRDEST @VIRTUAL06, 0 ;game_state.money_earned_since_last_call = @VIRTUAL06
	LDY #0
	STY @LOCAL03
	BRA @UNKNOWN7
@UNKNOWN6:

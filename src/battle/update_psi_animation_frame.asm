...
.ENDIF
	...
	.A16
	COPY_TO_VRAM1 PSI_ANIMATION_TILE_FLAGS, $5800, $400, $0F
	.A16
	LDY @VIRTUAL02
	MOVE_INT_YPTRSRC __BSS_START__, @VIRTUAL06
	LDA #$0400
...
@UNKNOWN3:
	.A16
	COPY_TO_VRAM1 PSI_ANIMATION_TILE_FLAGS+1, $5800, $800, $03
	JSL RESTORE_ANIMATED_BACKGROUND_COLOUR
@UNKNOWN4:
...
@UNKNOWN14:
	...
	CLC
	ADC @VIRTUALTMP02
	JSL INITIALIZE_BATTLE_SPRITE_PALETTE_EFFECT
	INC @VIRTUALTMP02
@UNKNOWN15:
	LDA @VIRTUALTMP02
	CMP #16
...
@UNKNOWN19:
	...
	TYX
	LDA #20
	JSL PREPARE_BATTLE_SPRITE_PALETTE_EFFECT_TABLES
@UNKNOWN20:
	LDY @LOCAL02
	INY
	STY @LOCAL02

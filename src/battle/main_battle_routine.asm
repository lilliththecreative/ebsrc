...
@UNKNOWN12:
	...
	BCC @UNKNOWN11
	JSL SET_INITIAL_BATTLE_SPRITE_POSITIONING
...
@UNKNOWN75:
	...
	TAX
	SEP #PROC_FLAGS::ACCUM8
	STZ PARTY_CHARACTERS + char_struct::is_auto_healed,X
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL10
	INC
	STA @LOCAL10
...
@UNKNOWN83:
	LDA @VIRTUAL02
	JSL REDIRECT_SWAP_RAISED_HP_PP_WINDOW
	LDY @LOCAL04
	TYX
	LDA @VIRTUAL04
	...
	.A16
	STA @LOCAL07
	JSL REDIRECT_RESET_ACTIVE_PARTY_MEMBER_HP_PP_WINDOW
	JSL REDIRECT_CLOSE_FOCUS_WINDOW
	LDA BATTLE_MODE
	BEQ @UNKNOWN84
	LDA @LOCAL07
...
@UNKNOWN150:
	...
	CMP #$FFFF
	BEQL @UNKNOWN235
	JSL REDIRECT_CLEAR_FOCUS_WINDOW
	LDA @VIRTUAL04
	LDY #.SIZEOF(battler)
	JSL MULT168
	CLC
...
@UNKNOWN162:
	...
	TAX
	LDA CURRENT_ATTACKER
	JSL TARGET_ENEMY_BY_BATTLER_INDEX
@UNKNOWN163:
	LDX #0
.IF .DEFINED(JPN)
	STX @LOCAL10
...
@UNKNOWN180:
	...
	SEP #PROC_FLAGS::ACCUM8
	LDA a:battler::current_action_argument,X
	JSL REDIRECT_SET_CITEM
	JSL PICK_NEXT_TARGET
	.A16
	LDX CURRENT_ATTACKER
	LDA a:battler::ally_or_enemy,X
	AND #$00FF
...
@UNKNOWN191:
	...
	LDA #12
	LDX CURRENT_ATTACKER
	STA a:battler::enemy_attack_flash_frames,X
	LDX #0
	STX @LOCAL07
	BRA @UNKNOWN193
@UNKNOWN192:
...
@UNKNOWN198:
	JSL WINDOW_TICK
@UNKNOWN199:
	JSL IS_BATTLE_ANIMATION_PLAYING
	CMP #0
	BNE @UNKNOWN198
	LDY #0
	STY @LOCAL05
...
@UNKNOWN238:
	JSL WINDOW_TICK
	JSL TRY_ENDING_FAST_HPPP_ROLLING
	CMP #0
	BEQ @UNKNOWN238
	LDA MIRROR_ENEMY
	BEQL @UNKNOWN243

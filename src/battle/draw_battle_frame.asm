...
@UNKNOWN2:
	...
	LDA BACKGROUND_BRIGHTNESS
	JSL ASR8_UNKNOWN1
	JSR ADJUST_ANIMATED_BACKGROUND_BRIGHTNESS_ALL
@UNKNOWN3:
...
@UNKNOWN11:
	...
	LDA f:VERTICAL_SHAKE_OFFSETS,X
...
@UNKNOWN21:
	...
	JSL GENERATE_BATTLEBG_FRAME
@UNKNOWN22:
	JSL UPDATE_PSI_ANIMATION_FRAME
...
@UNKNOWN27:
	LDA HP_PP_BOX_BLINK_TARGET
	JSL SHOW_HP_PP_WINDOW
@UNKNOWN28:
	JSL UPDATE_SWIRL_FRAME
	JSL SINGLE_BATTLE_SPRITE_PALETTE_EFFECT_FRAME
...
@UNKNOWN32:
	JSL UPDATE_LETTERBOX_HDMA_TABLE
@UNKNOWN33:
	END_C_FUNCTION

...
@UNKNOWN42:
	...
	JMP @UNKNOWN113
@UNKNOWN43:
	JSL ENABLE_HALF_HP_METER_SPEED
	LDA @LOCAL08
...
@UNKNOWN88:
	...
	JSL REDIRECT_BATTLE_SELECT_ITEM
	TAX
	BEQL @UNKNOWN63

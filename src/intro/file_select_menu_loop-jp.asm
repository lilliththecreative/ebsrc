...
@MENU_STARTGAME_SELECTED:
	...
	JMP @UNKNOWN59
@MENU_COPY_SELECTED:
	JSR HANDLE_FILE_COPY_MENU
	CMP #0
	BEQ @VALID_FILE_SELECTED
	BRA @MENU_OTHER_SELECTED
@MENU_DELETE_SELECTED:
	JSR HANDLE_FILE_DELETE_MENU
	CMP #0
	BEQ @VALID_FILE_SELECTED
	BRA @MENU_OTHER_SELECTED
@MENU_SETUP_SELECTED:
...
@UNKNOWN30:
	LDA @VIRTUAL02
	JSL EXIT_ANIMATED_NAMING_SPRITE
	LDA @LOCAL08
	STA @VIRTUAL04
	LDA @VIRTUAL02
	CLC
...
@UNKNOWN35:
	...
	JSL CREATE_NAMING_SUMMARY_ENTITIES
	LDA #1
	JSR SELECTION_MENU
	TAX
	BNE @EVERYTHING_OKAY
	JSL CLEAR_ENTITIES_INCLUDING_PARTY
	JMP @UNKNOWN18
@EVERYTHING_OKAY:
...
@UNKNOWN59:
	JSR CLOSE_ALL_WINDOWS
	JSL REINITIALIZE_ITEM_TRANSFORMATION
